...
ETC_5_dic = {'type': 'type_2', 'coin_No': 5, 'coin_Name': 'KRW-ETC', 'ma_duration_long': 102, 'ma_duration_mid': 30, 'ma_duration_short': 72, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus' : 0.0, 'successive_rise': 8, 'ratio_ema_mid_long': 0.99,              'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 0.5, 'under_long_duration': 30, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.5, 'ratio_peak_diff': 0.006, 'interm_sell_duration': 5, 'ratio_std_1': 0.2, 'ratio_std_2': 0.1, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

BTG_20_dic = {'type': 'type_2', 'coin_No': 20, 'coin_Name': 'KRW-BTG', 'ma_duration_long': 102, 'ma_duration_mid': 32, 'ma_duration_short': 53, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus' : 0.0, 'successive_rise': 7, 'ratio_ema_mid_long': 0.99,               'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 0.5, 'under_long_duration': 26, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.5, 'ratio_peak_diff': 0.005, 'interm_sell_duration': 4, 'ratio_std_1': 0.15, 'ratio_std_2': 0.07, 'ratio_sell_forced': 0.06, 'bought_state': 0, 'bought_price': 0.0}

ARK_14_dic = {'type': 'type_2', 'coin_No': 14, 'coin_Name': 'KRW-ARK', 'ma_duration_long': 91, 'ma_duration_mid': 27, 'ma_duration_short': 63, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus': 0.0, 'successive_rise': 8, 'ratio_ema_mid_long': 0.98,               'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 1.0, 'under_long_duration': 43, 'recent_vol_duration': 13, 'sell_method_vol_cri': 0.6, 'ratio_peak_diff': 0.006, 'interm_sell_duration': 999, 'ratio_std_1': 0.2, 'ratio_std_2': 0.1, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

WAXP_57_dic = {'type': 'type_2', 'coin_No': 57, 'coin_Name': 'KRW-WAXP', 'ma_duration_long': 101, 'ma_duration_mid': 23, 'ma_duration_short': 67, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus' : 0.00015, 'successive_rise': 8, 'ratio_ema_mid_long': 0.99,                'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0, 'diff_vol_aver': 0.5, 'under_long_duration': 37, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.3, 'ratio_peak_diff': 0.005, 'interm_sell_duration': 5, 'ratio_std_1': 0.17, 'ratio_std_2': 0.08, 'ratio_sell_forced': 0.04, 'bought_state': 0, 'bought_price': 0.0}

QTUM_9_dic = {'type': 'type_2', 'coin_No': 9, 'coin_Name': 'KRW-QTUM', 'ma_duration_long': 89, 'ma_duration_mid': 33, 'ma_duration_short': 77, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus' : 0.00015, 'successive_rise': 10, 'ratio_ema_mid_long': 0.99,               'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 0.5, 'under_long_duration': 39, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.4, 'ratio_peak_diff': 0.006, 'interm_sell_duration': 5, 'ratio_std_1': 0.15, 'ratio_std_2': 0.07, 'ratio_sell_forced': 0.07, 'bought_state': 0, 'bought_price': 0.0}

BCH_30_dic = {'type': 'type_2', 'coin_No': 30, 'coin_Name': 'KRW-BCH', 'ma_duration_long': 97, 'ma_duration_mid': 30, 'ma_duration_short': 70, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus' : 0.0, 'successive_rise': 8, 'ratio_ema_mid_long': 0.98,               'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 1.0, 'under_long_duration': 52, 'recent_vol_duration': 8, 'sell_method_vol_cri': 0.9, 'ratio_peak_diff': 0.006, 'interm_sell_duration': 6, 'ratio_std_1': 0.1, 'ratio_std_2': 0.05, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

BORA_72_dic = {'type': 'type_2', 'coin_No': 72, 'coin_Name': 'KRW-BORA', 'ma_duration_long': 101, 'ma_duration_mid': 35, 'ma_duration_short': 64, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0, 'successive_rise': 10, 'ratio_ema_mid_long': 0.99,                'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0, 'diff_vol_aver': 1.0, 'under_long_duration': 40, 'recent_vol_duration': 8, 'sell_method_vol_cri': 0.1, 'ratio_peak_diff': 0.007, 'interm_sell_duration': 3, 'ratio_std_1': 0.1, 'ratio_std_2': 0.05, 'ratio_sell_forced': 0.06, 'bought_state': 0, 'bought_price': 0.0}
...
def type_2_buy_sell_normal (target_dic) :
    ...
    if target_dic['bought_state'] == 0 :   # 매수가 없는 상태라면 
        ...
        if (DF_check['ratio_ema_long'][-3] > target_dic['ratio_ema_long_rise']) and (DF_check['ratio_ema_long'][-2] > target_dic['ratio_ema_long_rise']) and (DF_check['ratio_ema_long'][-1] > (target_dic['ratio_ema_long_rise'] + target_dic['recent_ratio_ema_long_plus'])) and (DF_check['ratio_ema_mid'][-1] > target_dic['ratio_ema_mid_rise']) and         (DF_check.iloc[-(target_dic['successive_rise'] + 2) : ]['rise_check_short'].sum() >= (target_dic['successive_rise'] - 0)) and         (DF_check['volume'][-2] >= (target_dic['ratio_vol_curr_prior'] * DF_check.iloc[-4 : -2]['volume'].mean())) and         (DF_check.iloc[-(target_dic['under_long_duration'] + 1) : -1]['mid_under_long'].sum() == 0) and (-DF_check.loc[DF_check.iloc[-(target_dic['under_long_duration'] + 1) : -1]['diff_m_l'].idxmin()]['diff_m_l'] > (target_dic['diff_m_l_factor'] * DF_check['open'][-1])) and         ((DF_check.loc[DF_check.iloc[-6 : -2]['recent_vol_aver'].idxmax()]['recent_vol_aver'] - DF_check['recent_vol_aver'][-2]) < target_dic['diff_vol_aver']) and         ((DF_check['ema_mid'][-1] / DF_check['ema_long'][-1]) > target_dic['ratio_ema_mid_long']) :
...
while True:
    try:
        ...
        if (15 < (now.minute % time_unit) <= 18) & (0 < (now.second % 60) <= 59):  # N시:01:00초 ~ N시:01:59초 사이 시각이면
